...
- Teaching **[CS3219 Software Engineering Principles and Patterns](https://nusmods.com/courses/CS3219/software-engineering-principles-and-patterns)** at NUS as an academic tutor, August to December 2026. It was the best module I took here and the one I wanted to come back to. Teams spend a semester on the decisions that actually bite: where a service boundary goes, which database suits the access pattern, how the thing gets deployed and stays up. My job is to make them defend those calls while they are still cheap to change
